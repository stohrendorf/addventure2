...
CREATE INDEX notificationUserIndex ON Notification (user_id);
CREATE INDEX notificationEpisodeIndex ON Notification (episode_id);
...
CREATE INDEX commentEpisodeIndex ON Comment (episode_id);
CREATE INDEX commentAuthorIndex ON Comment (author_name_id);
...
CREATE TABLE Episode (id INT NOT NULL, parent_id INT DEFAULT NULL, author_id INT DEFAULT NULL, storyline_tag_id INT DEFAULT NULL, title VARCHAR(255) DEFAULT NULL, created TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, postNotes TEXT DEFAULT NULL, preNotes TEXT DEFAULT NULL, text TEXT DEFAULT NULL, hitCount INT NOT NULL, likes INT NOT NULL, dislikes INT NOT NULL, linkable BOOLEAN NOT NULL, PRIMARY KEY(id));
